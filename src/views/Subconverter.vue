...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "mysciencevpn.vercel.app": "https://mysciencevpn.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://mysciencevpn.vercel.app/sub?" },
  ...
  methods: {
    ...
    makeUrl() {
      ...
      // 薯条屏蔽
      if (sourceSub.indexOf("losadhwse") !== -1 && (backend.indexOf("py6.pw") !== -1 || backend.indexOf("mysciencevpn.vercel.app") !== -1 || backend.indexOf("subconverter.herokuapp.com") !== -1 || backend.indexOf("api.wcc.best") !== -1)) {
